                    ...
                    <li class="dropdown ms-4">
                        @if(Auth::user()->profile_photo_path)
                            <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{asset(Auth::user()->profile_photo_path)}}" alt="" class="avatar avatar-md rounded-circle" />
                            </a>
                        @else
                            <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{asset('/')}}admin/assets/images/avatar/avatar-1.jpg" alt="" class="avatar avatar-md rounded-circle" />
                        ...
                        <div class="dropdown-menu dropdown-menu-end p-0">
                            ...
                            <div class="border-top px-5 py-3">
                                <a href="#" onclick="event.preventDefault(); document.getElementById('logoutForm').submit();" class="dropdown-item text-danger">
